...
<xsl:variable name="rem:lang_crq_lp_01">
	Die Information die vom System gespeichert wird soll die folgenden Anforderungen erfüllen:
</xsl:variable>
...
<xsl:variable name="rem:lang_uc_lp_02">
    abstrakter Use Case während der Ausführung des folgenden Use Case: 
</xsl:variable>
...
<xsl:variable name="rem:lang_uc_lp_04">
    oder während der Ausführung des folgenden Use Case:
</xsl:variable>
...
<xsl:variable name="rem:lang_ot_lp_01">
    Dieser Objekt-Typ repräsentiert
</xsl:variable>

<xsl:variable name="rem:lang_ot_lp_02">
    Dieser abstrakte Objekt-Typ repräsentiert
</xsl:variable>
...
<xsl:variable name="rem:lang_at_lp_01">
    Dieser Assoziationstyp repräsentiert die Tatsache, dass
</xsl:variable>
