...
<xsl:variable name="rem:lang_irq_lp_01">
    The system shall store the information corresponding to 
</xsl:variable>
...
<xsl:variable name="rem:lang_crq_lp_01">
	The information stored by the system shall satisfy the following constraint:
</xsl:variable>
...
<xsl:variable name="rem:lang_uc_lp_01">
    The system shall behave as described in the following
</xsl:variable>

<xsl:variable name="rem:lang_uc_lp_02">
    abstract use case during the performance of the following use cases: 
</xsl:variable>
...
<xsl:variable name="rem:lang_uc_lp_04">
    or during the performance of the following use cases:
</xsl:variable>
...
<xsl:variable name="rem:lang_ot_lp_01">
    This object type represents
</xsl:variable>

<xsl:variable name="rem:lang_ot_lp_02">
    This abstract object type represents
</xsl:variable>
...
<xsl:variable name="rem:lang_at_lp_01">
    This association type represents the fact that
</xsl:variable>
