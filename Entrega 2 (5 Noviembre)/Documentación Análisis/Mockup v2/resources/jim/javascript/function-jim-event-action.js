...
(function(window, undefined) {
  ...
  function getSVGChangeColorProgressFunction(svg, endColor) {
	...
	jQuery.each(paths, function (index, value) {
		...
		if (startStroke != undefined && startStroke != "none") {
		...
		if (startFill != undefined && startFill != "none") {
	...
	return function (progress) {
		for (var i = 0; i < startColorList.length; ++i) {
			...
			if (entry.startStroke != undefined) {
	                    ...
	                    if(domObject.css2svg && domObject.css2svg[attribute] != undefined) {
	                      ...
	                      if (cssAttrName == "overlay") {
	                    	if (calculatedValue != "none" && calculatedValue != "") {
							  if (animated) {
								(function (elem, newColor) {									
								  targetEntry.manualStepFunctions.push(getSVGChangeColorProgressFunction(elem, calculatedValue));
							...
							if (cssAttrName == "background-color" && (oldBackgroundImage.indexOf("linear-gradient") == 0 || oldBackgroundImage.indexOf("radial-gradient") == 0)) { 
							  ...
							  if (calculatedValue.indexOf("linear-gradient") == 0 || calculatedValue.indexOf("radial-gradient") == 0)
								calculatedValue = jimUtil.translateJimGradientToCSS(calculatedValue, $target[0].offsetWidth, $target[0].offsetHeight);
							...
							//BACKGROUND IMAGE CHANGE NOT ANIMATED - fix
